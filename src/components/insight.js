    ...
    return (
      <div>
        <div class="green-insight">
          ...
          <ul>
            <li class="nav-item">
              <a href="https://www.tandfonline.com/doi/abs/10.1080/09613218.2017.1314148?journalCode=rbri20"><font color="MediumSeaGreen" size="1.2rem">Parkinson A.T., Reid R., McKerrow H., Wright D. (2017) Evaluating positivist theories of occupant satisfaction: a statistical analysis, Building Research and Information, 46(7):1-14.</font></a>
            </li>
            <li class="nav-item">
              <a href="https://www.sciencedirect.com/science/article/abs/pii/S0360544216302638"><font color="MediumSeaGreen" size="1.2rem">Parkinson A.T., Hill S., Wheal R. (2016) An income-based analysis of the value premise for property energy performance, Energy, 106:162-169</font></a>
            </li>
            <li class="nav-item">
        ...
        <Row style={rowStyle}>
          <Col style={parStyle}>
            <div class="red-insight">
              ...
              <ul>
                <li class="nav-item">
                  <a href="https://www.journals.elsevier.com/energy"><font color="Tomato" size="1.2rem">Energy</font></a>
                </li>
                <li class="nav-item">
                  <a href="https://www.journals.elsevier.com/energy-policy"><font color="Tomato" size="1.2rem">Energy Policy</font></a>
                </li>
                <li class="nav-item">
                  <a href="https://www.journals.elsevier.com/applied-energy"><font color="Tomato" size="1.2rem">Applied Energy</font></a>
                </li>
                <li class="nav-item">
                  <a href="https://www.journals.elsevier.com/sustainable-cities-and-society"><font color="Tomato" size="1.2rem">Sustainable Cities and Society</font></a>
                </li>
                <li class="nav-item">
                  <a href="https://www.journals.elsevier.com/energy-economics"><font color="Tomato" size="1.2rem">Energy Economics</font></a>
                </li>
                <li class="nav-item">
                  <a href="https://www.journals.elsevier.com/journal-of-environmental-management"><font color="Tomato" size="1.2rem">Journal of Environmental Management</font></a>
                </li>
              </ul>
            </div>
          </Col>
