...
\title{Dr Aidan Thomas Parkinson BEng(Hons) MSc PhD CEng MCIBSE}
\author{}
...
\begin{table}[h]
\caption*{Grants and Awards}
\vspace{-5mm}
\small
\begin{center}
\begin{tabular}{p{0.15\linewidth} p{0.8\linewidth}}
\hline
2017&Engineering Council, \emph{CEng} \\
2017 &Member of CIBSE, \emph{MCIBSE} \\
...
&Preparation of a stage 4 smart buildings specification. \\
2021&\textbf{Museum of London} \\
&Preparation of a stage 4 HVAC controls specification \\
2019 - 2020&\textbf{Google KGX1} \\
&Review of all technical submittals by specialist contractors for compliance with system integration requirements. \\
2018&\textbf{Delos/Arup Workplace Wellbeing Survey} \\
&Collaboration between Delos Insights and Arup to develop a wellbeing questionnaire, to be applied in particular to WELL Standard projects. \\
